...
class Constants:
    ...
    save_path = os.path.join(project_path.parents[0], "out")
...
def main(args, path):
    ...
    # trainer
    trainer = Trainer(accelerator="gpu", devices=args.gpu, min_epochs=args.min_epochs, max_epochs=args.epochs,
...
if __name__ == "__main__":
    ...
    # experiment folder
    path = create_experiment_folder(os.path.join(Constants.save_path, 'experiments', args.dataset_name, args.backbone),
